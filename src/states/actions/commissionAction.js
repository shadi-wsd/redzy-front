...
export const createCommission = (level, commissionValue) => async (dispatch) => {
    try {
        ...
        const res = await axios.post(`${globalLink}/api/create-commission-level`, { level, commissionValue }, config, axios.defaults.withCredentials = true);
...
// delete detail::begin
export const updateCommission = (commissionLevelId, level, commissionValue) => async (dispatch) => {
    try {
        ...
        const res = await axios.post(`${globalLink}/api/edit-commission-level`, { commissionLevelId, commissionValue, level }, config, axios.defaults.withCredentials = true);
