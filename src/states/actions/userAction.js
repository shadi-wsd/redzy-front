...
export const updateUser = (userId, accountLevel, status, accountStatus) => async (dispatch) => {
    try {
        ...
        const res = await axios.put(`${globalLink}/api/update-user`, { userId, accountLevel, status, accountStatus }, config, axios.defaults.withCredentials = true);
