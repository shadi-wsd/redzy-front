        ...
        <>
            ...
            <section className="user-setting-section background_texture">
                <div className="setting-header">
                    <MobileBreadcrumb name="Setting" nav="/userDashboard/home" isLogout={false} color={'#0046d1'} />
                </div>
                ...
                </div>
                {
                    selectedOption === "Option 1"
                        ...
                        <div className="changePasswordForm">
                            <div>
                                <i class="fa fa-lock" style={{ color: "#0046d1" }}></i>
                                <input
                            ...
                            <div>
                                <i class="fa fa-unlock" style={{ color: "#0046d1" }}></i>
                                <input
                            ...
                            <div>
                                <i className="fa fa-key" style={{ color: "#0046d1" }}></i>
                                <input
